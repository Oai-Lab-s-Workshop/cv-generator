...
POCKETBASE_INTERNAL_PORT_DEFAULT=8090
MCP_PORT_DEFAULT=8081
...
load_env_file() {
  ...
  source "$ENV_FILE"
  set +a
  : "${POCKETBASE_INTERNAL_PORT:=$POCKETBASE_INTERNAL_PORT_DEFAULT}"
  : "${MCP_PORT:=$MCP_PORT_DEFAULT}"
  : "${MCP_INTERNAL_PORT:=$MCP_INTERNAL_PORT_DEFAULT}"
  : "${FRONTEND_PORT:=$FRONTEND_PORT_DEFAULT}"
  : "${FRONTEND_INTERNAL_PORT:=$FRONTEND_INTERNAL_PORT_DEFAULT}"
  : "${PB_URL:=http://localhost:$FRONTEND_PORT}"
  ...
  export POCKETBASE_INTERNAL_PORT MCP_PORT MCP_INTERNAL_PORT FRONTEND_PORT FRONTEND_INTERNAL_PORT
  export PB_URL POCKETBASE_BASE_URL FRONTEND_BASE_URL
