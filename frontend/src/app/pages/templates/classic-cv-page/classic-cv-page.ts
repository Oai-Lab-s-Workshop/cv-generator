...
import { ProfileSummaryChip } from '../../../shared/components/profile-summary-chip/profile-summary-chip';
...
@Component({
  ...
  imports: [ProjectChip, AchievementChip, EducationChip, ProfileSummaryChip],
